    ...
    <body>
       ...
       <div class = "row no-gutters mt-5">
            <div class = "col-md-2 bg-dark mt-2 pr-3 pt-4">
                ...
                <li class="nav-item">
                        <a class="nav-link active text-white" href="dashboard.php"><i class="fas fa-user"></i> User </a><hr class = "bg-secondary">
                    </li>
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="kepegawaian.php"><i class="fas fa-folder"></i> Arsip Kepegawaian </a><hr class = "bg-white">
                    </li>
                    <li class="nav-item">
